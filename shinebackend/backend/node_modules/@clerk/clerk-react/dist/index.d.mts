...
import { Without, SignInProps, SignUpProps, CreateOrganizationProps, OrganizationListProps, OneTapProps, UserProfileProps, OrganizationProfileProps, UserButtonProps, OrganizationSwitcherProps, SignOutOptions, SignOut, GetToken, ActJWTClaim, OrganizationCustomRoleKey, CheckAuthorizationWithCustomPermissions, SignInResource, SignUpResource, EmailAddressResource, CreateEmailLinkFlowReturn, SignInStartEmailLinkFlowParams, StartEmailLinkFlowParams, SetActive } from '@clerk/types';
import React, { PropsWithChildren } from 'react';
import { W as WithClerkProp, U as UserProfilePageProps, a as UserProfileLinkProps, O as OrganizationProfilePageProps, b as OrganizationProfileLinkProps, S as SignInButtonProps, c as SignUpButtonProps, d as SignInWithMetamaskButtonProps, C as ClerkProviderProps } from './controlComponents-DPxaqPME.mjs';
export { A as AuthenticateWithRedirectCallback, B as BrowserClerk, f as ClerkLoaded, g as ClerkLoading, e as ClerkProp, H as HeadlessBrowserClerk, P as Protect, n as ProtectProps, l as RedirectToCreateOrganization, m as RedirectToOrganizationProfile, R as RedirectToSignIn, j as RedirectToSignUp, k as RedirectToUserProfile, i as SignedIn, h as SignedOut } from './controlComponents-DPxaqPME.mjs';
...
declare const __experimental_GoogleOneTap: {
    (props: Without<WithClerkProp<OneTapProps>, "clerk">): React.JSX.Element | null;
    displayName: string;
};
...
export { ClerkProvider, ClerkProviderProps, CreateOrganization, OrganizationList, OrganizationProfile, OrganizationSwitcher, SignIn, SignInButton, SignInWithMetamaskButton, SignOutButton, SignUp, SignUpButton, UserButton, UserProfile, __experimental_GoogleOneTap, useAuth, useEmailLink, useSignIn, useSignUp };
