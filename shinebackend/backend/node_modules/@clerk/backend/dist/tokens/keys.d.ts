 ...
 * @returns {JsonWebKey} key
 */
export declare function loadClerkJWKFromRemote({ secretKey, apiUrl, apiVersion, kid, jwksCacheTtlInMs, skipJwksCache, }: LoadClerkJWKFromRemoteOptions): Promise<JsonWebKey>;
