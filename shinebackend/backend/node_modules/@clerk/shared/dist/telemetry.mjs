...
var TelemetryCollector = class {
  ...
  record(event) {
    ...
    if (!__privateMethod(this, _shouldRecord, shouldRecord_fn).call(this, event.eventSamplingRate)) {
      return;
    }
...
shouldRecord_fn = function(eventSamplingRate) {
  ...
  const shouldBeSampled = randomSeed <= __privateGet(this, _config).samplingRate && (typeof eventSamplingRate === "undefined" || randomSeed <= eventSamplingRate);
