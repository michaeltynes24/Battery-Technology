...
const NewUser = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await api.post('/api/userextension/', {
    ...
    return (
        <Box sx={{ maxWidth: '80%', mx: 'auto', mt: 7, mb: 3 }}>
            <Typography sx={{ justifyContent: 'center', display: 'flex' }} variant="h4" gutterBottom>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <FormControlLabel
                    control={<Checkbox checked={importGreenButton} onChange={(e) => setImportGreenButton(e.target.checked)} />}
                ...
                {/* Solar Checkbox */}
                <FormControlLabel
                    control={<Checkbox checked={solar} onChange={(e) => setSolar(e.target.checked)} />}
